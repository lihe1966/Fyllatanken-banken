...
import create_recipe_url from "./get-ica-recipes";
import { Recipe } from "./recipe";
import { printRecipe, searchByIngred , searchByName} from "./mainForTest";


test("Testar att skapa ett create_recipe_url", async () => {
    ...
    expect(recipe.amounts).toEqual(["", "", "100 g", "2 st", "2 1/2 dl",
      "3 msk", "2 tsk", "1 1/2 dl", "1 krm", "", "2 dl", ""]);
});
